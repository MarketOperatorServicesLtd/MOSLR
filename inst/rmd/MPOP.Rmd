...
wb <- openxlsx::createWorkbook("MPOP_tables")

openxlsx::addWorksheet(wb, "Longunread_numbers")
openxlsx::addWorksheet(wb, "Longunread_numbers_Since_MO")
openxlsx::addWorksheet(wb, "Longunread_percent")

openxlsx::addWorksheet(wb, "Vacant_numbers")
openxlsx::addWorksheet(wb, "Vacant_percent")
...
top10_vac_ret <- graph_data%>%
  ...
  dplyr::mutate(
   ...
   dplyr::select(Retailer, TotalPremises, Vacancies, percent_temp)
...
top10_vac_whole <- graph_data%>%
  ...
  dplyr::select(Wholesaler, TotalPremises, Vacancies, percent_temp)
...
top10_vac_pair <- graph_data%>%
  ...
  dplyr::mutate(
   ...
   dplyr::select(Pair, TotalPremises, Vacancies, percent_temp)
...
openxlsx::writeData(wb, sheet = "Vacant_numbers", x = vacant_total)
...
openxlsx::writeData(wb, sheet = "Vacant_percent", x = vacant_percent)
